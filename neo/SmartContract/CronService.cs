...
{
    public class CronService : StandardService
    {
        public CronService(TriggerType trigger, Snapshot snapshot)
            : base(trigger, snapshot)
        {
            Register("Cron.Runtime.GetTrigger", Runtime_GetTrigger, 1);
            Register("Cron.Runtime.CheckWitness", Runtime_CheckWitness, 200);
            Register("Cron.Runtime.Notify", Runtime_Notify, 1);
            Register("Cron.Runtime.Log", Runtime_Log, 1);
            Register("Cron.Runtime.GetTime", Runtime_GetTime, 1);
            Register("Cron.Runtime.Serialize", Runtime_Serialize, 1);
            Register("Cron.Runtime.Deserialize", Runtime_Deserialize, 1);
            Register("Cron.Blockchain.GetHeight", Blockchain_GetHeight, 1);
            Register("Cron.Blockchain.GetHeader", Blockchain_GetHeader, 100);
            Register("Cron.Blockchain.GetBlock", Blockchain_GetBlock, 200);
            Register("Cron.Blockchain.GetTransaction", Blockchain_GetTransaction, 100);
            Register("Cron.Blockchain.GetTransactionHeight", Blockchain_GetTransactionHeight, 100);
            Register("Cron.Blockchain.GetAccount", Blockchain_GetAccount, 100);
            Register("Cron.Blockchain.GetValidators", Blockchain_GetValidators, 200);
            Register("Cron.Blockchain.GetAsset", Blockchain_GetAsset, 100);
            Register("Cron.Blockchain.GetContract", Blockchain_GetContract, 100);
            Register("Cron.Header.GetHash", Header_GetHash, 1);
            Register("Cron.Header.GetVersion", Header_GetVersion, 1);
            Register("Cron.Header.GetPrevHash", Header_GetPrevHash, 1);
            Register("Cron.Header.GetMerkleRoot", Header_GetMerkleRoot, 1);
            Register("Cron.Header.GetTimestamp", Header_GetTimestamp, 1);
            Register("Cron.Header.GetIndex", Header_GetIndex, 1);
            Register("Cron.Header.GetConsensusData", Header_GetConsensusData, 1);
            Register("Cron.Header.GetNextConsensus", Header_GetNextConsensus, 1);
            Register("Cron.Block.GetTransactionCount", Block_GetTransactionCount, 1);
            Register("Cron.Block.GetTransactions", Block_GetTransactions, 1);
            Register("Cron.Block.GetTransaction", Block_GetTransaction, 1);
            Register("Cron.Transaction.GetHash", Transaction_GetHash, 1);
            Register("Cron.Transaction.GetType", Transaction_GetType, 1);
            Register("Cron.Transaction.GetAttributes", Transaction_GetAttributes, 1);
            Register("Cron.Transaction.GetInputs", Transaction_GetInputs, 1);
            Register("Cron.Transaction.GetOutputs", Transaction_GetOutputs, 1);
            Register("Cron.Transaction.GetReferences", Transaction_GetReferences, 200);
            Register("Cron.Transaction.GetUnspentCoins", Transaction_GetUnspentCoins, 200);
            Register("Cron.Transaction.GetWitnesses", Transaction_GetWitnesses, 200);
            Register("Cron.InvocationTransaction.GetScript", InvocationTransaction_GetScript, 1);
            Register("Cron.Witness.GetVerificationScript", Witness_GetVerificationScript, 100);
            Register("Cron.Attribute.GetUsage", Attribute_GetUsage, 1);
            Register("Cron.Attribute.GetData", Attribute_GetData, 1);
            Register("Cron.Input.GetHash", Input_GetHash, 1);
            Register("Cron.Input.GetIndex", Input_GetIndex, 1);
            Register("Cron.Output.GetAssetId", Output_GetAssetId, 1);
            Register("Cron.Output.GetValue", Output_GetValue, 1);
            Register("Cron.Output.GetScriptHash", Output_GetScriptHash, 1);
            Register("Cron.Account.GetScriptHash", Account_GetScriptHash, 1);
            Register("Cron.Account.GetVotes", Account_GetVotes, 1);
            Register("Cron.Account.GetBalance", Account_GetBalance, 1);
            Register("Cron.Account.IsStandard", Account_IsStandard, 100);
            Register("Cron.Asset.Create", Asset_Create);
            Register("Cron.Asset.Renew", Asset_Renew);
            Register("Cron.Asset.GetAssetId", Asset_GetAssetId, 1);
            Register("Cron.Asset.GetAssetType", Asset_GetAssetType, 1);
            Register("Cron.Asset.GetAmount", Asset_GetAmount, 1);
            Register("Cron.Asset.GetAvailable", Asset_GetAvailable, 1);
            Register("Cron.Asset.GetPrecision", Asset_GetPrecision, 1);
            Register("Cron.Asset.GetOwner", Asset_GetOwner, 1);
            Register("Cron.Asset.GetAdmin", Asset_GetAdmin, 1);
            Register("Cron.Asset.GetIssuer", Asset_GetIssuer, 1);
            Register("Cron.Contract.Create", Contract_Create);
            Register("Cron.Contract.Migrate", Contract_Migrate);
            Register("Cron.Contract.Destroy", Contract_Destroy, 1);
            Register("Cron.Contract.GetScript", Contract_GetScript, 1);
            Register("Cron.Contract.IsPayable", Contract_IsPayable, 1);
            Register("Cron.Contract.GetStorageContext", Contract_GetStorageContext, 1);
            Register("Cron.Storage.GetContext", Storage_GetContext, 1);
            Register("Cron.Storage.GetReadOnlyContext", Storage_GetReadOnlyContext, 1);
            Register("Cron.Storage.Get", Storage_Get, 100);
            Register("Cron.Storage.Put", Storage_Put);
            Register("Cron.Storage.Delete", Storage_Delete, 100);
            Register("Cron.Storage.Find", Storage_Find, 1);
            Register("Cron.StorageContext.AsReadOnly", StorageContext_AsReadOnly, 1);
            Register("Cron.Enumerator.Create", Enumerator_Create, 1);
            Register("Cron.Enumerator.Next", Enumerator_Next, 1);
            Register("Cron.Enumerator.Value", Enumerator_Value, 1);
            Register("Cron.Enumerator.Concat", Enumerator_Concat, 1);
            Register("Cron.Iterator.Create", Iterator_Create, 1);
            Register("Cron.Iterator.Key", Iterator_Key, 1);
            Register("Cron.Iterator.Keys", Iterator_Keys, 1);
            Register("Cron.Iterator.Values", Iterator_Values, 1);
            Register("Cron.Iterator.Concat", Iterator_Concat, 1);
            Register("Cron.Cryptography.Secp256k1Recover", Secp256k1Recover, 100);
            Register("Cron.Cryptography.Secp256r1Recover", Secp256r1Recover, 100);

            #region Aliases
            Register("Cron.Iterator.Next", Enumerator_Next, 1);
            Register("Cron.Iterator.Value", Enumerator_Value, 1);
            #endregion
